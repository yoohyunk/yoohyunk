...
- Building branding websites and automated lead generation at **[Moet Studio](https://meot.ca)**
- Previously led teams shipping production apps at **YYCFoodTrucks** and **Roll'in in Dough Vernon**
- Working on **[FairSplit](https://github.com/yoohyunk)** — a Splitwise alternative with receipt scanning and itemized expense sharing
...
#### [FairSplit](https://github.com/yoohyunk)
React Native + Django expense management app. Scan a receipt, extract items with OCR, and split costs at the item level — not just by total. PostgreSQL + AWS S3 backend.

`React Native` `Django` `OCR` `PostgreSQL` `AWS S3`

</td>
<td width="50%" valign="top">

#### [Tic-Tac-Toe AI](https://github.com/yoohyunk)
Real-time multiplayer mobile game with matchmaking, game lobbies, and a configurable AI that stays beatable on any board size. 3D-inspired UI with sound effects.

`React Native` `Google Firestore` `AI Heuristics`
